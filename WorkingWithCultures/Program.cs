...
// AddLocxalization, AddTransient<T>
...
using IHost host = Host.CreateDefaultBuilder(args)
    .ConfigureServices(services =>
    {
        ...
        services.AddTransient<AiOResources>();
    })
    .Build();
...
AiOResources resources = host.Services.GetRequiredService<AiOResources>();
...
{
    // if they not enter a DOB then use sensible defaults for their culture
